	...
	chart1 = new Chart(document.getElementById("chart1"), {
	  ...
	  data: {
	    datasets: [{
	      ...
	      fill: false,
	      backgroundColor: "rgb(74, 222, 222)"
	    }],
	    labels: ["A", "B", "C"]
	  },
...
function getCircle1(cost, volume) {
	...
	// }
	elem.innerHTML = "<h3>"+(100*(costScenario1-cost)/costScenario1).toFixed(1)+"%</h3><p>Savings wrt 30% accuracy model</p>";
}
